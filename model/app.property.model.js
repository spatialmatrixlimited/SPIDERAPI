...
var propertySchema = new PropertySchema({
    ...
    property: {
        ...
        master_building_serial_number: { type: String, default: '' },
    ...
    parsed_photo: { type: Boolean, default: false }
});

module.exports = mongoose.model('PropertyCollection', propertySchema, 'properties');